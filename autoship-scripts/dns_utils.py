    ...
    def validate_subdomain(subdomain: str) -> bool:
        ...
        print(f"Welcome to validate_subdomain! This is inside dns_utils.py. This function will validate the subdomain: {subdomain}")
    ...
    def add_dns_record(subdomain: str, public_ip: str) -> bool:
        print(f"Welcome to add_dns_record! This is inside dns_utils.py. This function will add a DNS record for {subdomain} pointing to {public_ip}.")
        """
